...
function App(){const fileInputRef=useRef(null);const [tab,setTab]=useState('research'),[rows,setRows]=useState(demo),[history,setHistory]=useState([]),[summary,setSummary]=useState(null),[counts,setCounts]=useState({}),[query,setQuery]=useState(''),[message,setMessage]=useState(''),[loading,setLoading]=useState(false),[configured,setConfigured]=useState(false),[selected,setSelected]=useState(null),[validation,setValidation]=useState(null),[orchestrator,setOrchestrator]=useState(null);
...
function openFilePicker(){fileInputRef.current?.click()}
 ...
 <Orchestrator job={orchestrator?.job} registry={orchestrator?.registry||DEFAULT_BOTS}/>
